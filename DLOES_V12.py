...
class DLOExtendService(object):
    ...
    def UpdateExtension(self,Selection):
        if Selection == "1":
            ...
            while ContinueOrQuite == ("1"):
                ...
                print('当前目标扩展名为\n%s'% DLOExtendService.Get(self,("ExtensionList")))
            ...
            while ContinueOrQuite == ("1"):
                ...
                print(DLOExtendService.UpdateExtension(self,("2")))
    ...
    def Flow(self):
        ...
        DLOExtendService.UpdateExtension(self,input("Python.DLOES:当前目标扩展名为\n%s\n      "
                                                    "按<1>添加扩展名\n      "
                                                    "按<2>删除扩展名\n      "
